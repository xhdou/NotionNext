...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: 'NIGHT DANCER',  
      artist: 'imase',
      url: 'https://music.163.com/song/media/outer/url?id=3378397695.mp3',
      cover:
        'https://p2.music.126.net/nkaQLQfD-LecWXyiWc5bmA==/109951173142128981.jpg?param=130y130'
    },
    {
      name: 'Run Wild（向风而野）',  
      artist: '王有有',
      url: 'https://music.163.com/song/media/outer/url?id=3376200257.mp3',
      cover:
        'https://p2.music.126.net/nkaQLQfD-LecWXyiWc5bmA==/109951173142128981.jpg?param=130y130'
    }
  ],
